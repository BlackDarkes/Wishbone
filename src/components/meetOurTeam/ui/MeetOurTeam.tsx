  ...
  return (
    <section>
      <Container size="midle" className="gap-x-[40px] max-[1024px]:flex-col py-[clamp(60px,7vw,100px)]">
        <motion.div initial={{ opacity: 0, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="w-[min(100%,370px)] self-start max-[1024px]:self-center">
          <div>
        ...
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.6, delay: 0.9 }} viewport={{ once: true }} className="grid grid-cols-2 w-[min(100%,770px)] gap-[40px] max-[767px]:grid-cols-1 max-[767px]:items-center max-[767px]:gap-y-[20px] max-[767px]:w-[min(100%,370px)] max-[767px]:mt-[50px]">
